    ...
    describe('DB', () => {
        ...
        describe('fields()', () => {
            ...
            it('handles multiple fields via array', () => {
                expect(q.fields(['name', 'login'])._fields).toEqual(expect.arrayContaining([
                    { field: 'name', table: undefined },
                    { field: 'login', table: undefined },
                ]));
            });
            it('handles multiple fields and a scheme via array', () => {
                expect(q.fields(['styria.name', 'styria.login'])._fields).toEqual(expect.arrayContaining([
        ...
        describe('where()', () => {
            ...
            it('handles multiple statements on the same query', () => {
                expect(q.where('name', '=', 'admin').where('login', '=', 'admin')._wheres).toEqual(expect.arrayContaining([
        ...
        describe('distinct()', () => {
            ...
            it('handles multiple fields', () => {
                expect(q.distinct(['login', 'name'])._distinct).toEqual(expect.arrayContaining([
                    { field: 'login', table: undefined },
                    { field: 'name', table: undefined },
                ]));
            });
            it('handles schema statements', () => {
                ...
                expect(q.distinct(['user.login', 'user.name'])._distinct).toEqual(expect.arrayContaining([
        ...
        describe('join()', () => {
            it('handles the simple statement', () => {
                expect(q.join('roles', 'id', 'userid')._joins).toEqual(expect.arrayContaining([
                    {
                        collection: 'roles',
                        field1: 'id',
                        field2: 'userid',
            ...
            it('handles schemas', () => {
                expect(q.join('roles', 'user.id', 'roles.userid')._joins).toEqual(expect.arrayContaining([
                    {
                        collection: 'roles',
                        field1: 'id',
                        field2: 'userid',
            ...
            it('handles setting the modifier', () => {
                expect(q.join('roles', 'id', 'userid', 'OUTER')._joins).toEqual(expect.arrayContaining([
                    {
                        collection: 'roles',
                        field1: 'id',
                        field2: 'userid',
        ...
        describe('set()', () => {
            ...
            it('handles setting multiple values with an object', () => {
                ...
                expect(q.set(insert)._sets).toEqual(expect.arrayContaining([
